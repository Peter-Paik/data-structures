...
public class ListDemo
{
    public static void main(String[] args)
    {
        ...
        /*
         * The listIterator method creates a new list iterator taht is positioned at the head of the list
        ...
        /*The next method also retursn the element that hte iterator is passing */
        ...
        */
        ...
        /* The set method updates the elements returned by the last call to next or previous */
         ...
         */
        iterator = staff.listIterator(); //rests |TNSG
